...
public class Cards {
	public static Card debug(){return new Card("dummy", "desc", Arrays.asList(new ICardEffect[]{}), new FilterIdentity()); }
	public static Card move(){ return new Card("Move", "Move to an adjacent tile", Arrays.asList(new ICardEffect[]{CardEffects.MOVE, CardEffects.DISCARD}), new FilterInvert(TileFilters.FILTER_ADJACENT, TileFilters.FILTER_FULL));}
	...
	public static Card wall() { return new Card("Wall", "Fill the target tile with walls. A full tile blocks movement.", Arrays.asList(new ICardEffect[]{CardEffects.WALL(), CardEffects.DISCARD}), TileFilters.FILTER_HAS_SPACE);}
